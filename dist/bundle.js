...
})(["require", "exports", 'react', './main'], function (require, exports) {
    var React = require('react');
    var main_1 = require('./main');
    React.render(React.createElement(main_1.Main), document.getElementById('main'));
});

},{"./main":2,"react":159}],2:[function(require,module,exports){
/// <reference path="../typings/bundle.d.ts" />
...
},{"./todoItem":3,"react":159}],3:[function(require,module,exports){
/// <reference path="../typings/bundle.d.ts" />
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
